...
text width=10em, text centered, minimum height=4em, node distance=3cm]
...
\begin{figure}
	...
	\node [cheap, below of=in](inputLegend) at(-3.6,0.3) {
		\small\begin{itemize}
		\item mesh size 
	...
	\node [cheap, below of = out] (outLegend) at(3.5, 0.3) {
		\small\begin{itemize}
